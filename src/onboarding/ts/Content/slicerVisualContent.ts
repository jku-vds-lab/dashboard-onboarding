...
export default class Slicer extends Visualization {
  ...
  async getSlicerInfo(visual: VisualDescriptor, expertiseLevel: ExpertiseLevel) {
    await this.setVisualization(visual);

    this.text = this.textDescription.getTextWithUserLevel(expertiseLevel, "slicer", this);
    return this.text;
  }
}
